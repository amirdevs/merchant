...
/docs/15_USEFUL_NPC_IDENTITY_MEGA_BATCH.md
```
...
Useful-new-NPC identity catalog files live in:
...
- Character roadmap work should be grouped into large phases/batches instead of many tiny roadmap steps.
