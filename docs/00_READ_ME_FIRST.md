...
4. `03_GAME_LOGIC_AND_ROADMAP.md` - implemented game logic, playable UI roadmap, character rework plan, and portrait gates.
...
- Update an existing roadmap/system doc instead of creating new docs.
