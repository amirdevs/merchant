# Written Item Copy Progress

Draft review only. Do not merge until approved.

This file tracks the manually authored static item copy for PR #9.

## Current status

- Actual game items: 2206
- Hand-written entries completed: 1992
- Remaining: 214
- Last completed item index: 1991
- Next start point: 1992

## Completed batches

- 0–43: currency, the Sunwake Harbor share, Painted Coast annals, local chronicles, primers, almanacs, and practical directories.
- 44–91: Crowncards books, magic/luck books, battle reports, trade essays, field guides, letters, and first gem items.
- 92–141: scarce/fabled gemstones, crowns, colored crystals, gem necklaces, and rings.
- 142–191: additional rings plus the first spice/herb goods.
- 192–241: remaining spices/aromatics, poisons, potions, remedies, alchemy solutions, and first alchemy tools.
- 242–291: alchemy workbench tools, oozes, jellies, turtles, frogs, scorpions, spiders, beetles, butterflies, moths, and first giant insects.
- 292–341: giant insects, moths, hive queens/workers, hounds, wolves, bats, rats, bears, megafauna, reptiles, and snakes.
- 342–391: remaining snakes and worms, farm animals, small birds, horse barding, dragon armors, gauntlets, war gloves, and first helmets.
- 392–441: helmets, mail shirts, plate armor, leather armor, named faction armor, exotic breastplates, iron boots, and the shield of Pearlgate.
- 442–491: named shields, bucklers, banners, an empty book, flowers, rare botanicals, and first mushrooms.
- 492–541: remaining mushrooms, leaves, pond pads, odd herbs, wetland plants, rare red plants, and named botanicals.
- 542–591: colored bushes, seaweed, rare botanicals, seeds, seedlings, branches, logs, stump, scarves, and cloaks.
- 592–641: coats, dresses, gloves, caps, veils, masks, skin rags, and robes.
- 642–691: footwear, legwear, undergarments, tunics, monk robes, and the first regional coats of arms.
- 692–741: remaining regional coats of arms, copper and silver vessels, stoves, pots, land deeds, and first drinks.
- 742–791: remaining drinks, flags, bread, beans, tea goods, hops, dairy, eggs, oil, vinegar, and first sweets.
...
Each actual game item should receive individually written `shortDescription` and `flavorText` based on its own name and identity. No helper-generated or sentence-combined copy should be treated as final.
