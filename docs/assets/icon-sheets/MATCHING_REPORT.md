...
Source branch inspected: `main`. Temporary branch used only to run the GitHub Actions commit workflow: `chatgpt-icon-tools`; workflow files are not committed to main.

Matching method: JSON configs sorted by filename; ChatGPT exported sheets sorted by timestamp plus numeric suffix; valid images renamed to JSON basename. Review overlays are JPG files to keep repository size lower than PNG overlays.

- Prompt configs: 101
- Source sheet files: 101
- Renamed valid sheets included: 100
- Invalid/corrupt source files in `unmatched/`: 1
- PASS: 99
- FAIL: 2

## Important failures
- `items-4001-4050.json` from `ChatGPT Image Jun 19, 2026, 07_42_43 PM (1).png`: **FAIL** — Corrupt/invalid PNG; cannot open as image. Error: cannot identify image file '/home/runner/work/merchant/merchant/docs/assets/icon-sheets/ChatGPT Image Jun 19, 2026, 07_42_43 PM (1).png'
- `items-5001-5006.json` from `ChatGPT Image Jun 19, 2026, 07_46_14 PM.png`: **FAIL** — R1C7 extra_art
...
| `items-4001-4050.json` | `ChatGPT Image Jun 19, 2026, 07_42_43 PM (1).png` | `NOT_RENAMED` | FAIL | Corrupt/invalid PNG; cannot open as image. Error: cannot identify image file '/home/runner/work/merchant/merchant/docs/assets/icon-sheets/ChatGPT Image Jun 19, 2026, 07_42_43 PM (1).png' |
...
| `items-5001-5006.json` | `ChatGPT Image Jun 19, 2026, 07_46_14 PM.png` | `items-5001-5006.png` | FAIL | R1C7 extra_art |
