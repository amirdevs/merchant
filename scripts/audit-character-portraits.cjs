...
const generatedCharactersPath = path.join(root, "src", "data", "generated", "characters.json");
const identityDir = path.join(root, "src", "data", "characters");
