...
const stockArchetypes = extractObject(path.join(root, "src", "content", "market", "stock", "archetypes.ts"), "stockArchetypes");
const professionStockProfiles = extractObject(path.join(root, "src", "content", "market", "stock", "profiles.ts"), "professionStockProfiles");
