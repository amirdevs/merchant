import type { QuestChoice, QuestConsequence, QuestReward, QuestUnlock } from "@/content/quests/questTypes";
import { recordRichQuestChoice, resolveRichQuest, type RichQuestRuntimeState } from "@/game/quests/quest-state";
