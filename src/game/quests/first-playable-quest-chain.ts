import { questCatalog } from "@/content/quests/questCatalog";
import type { QuestChoice, RichQuest, RichQuestStatus } from "@/content/quests/questTypes";
import { buildVerticalSliceJournal, type RichQuestJournalEntry } from "@/game/quests/quest-journal-view-model";
import { verticalSliceRichQuests } from "@/game/quests/quest-selectors";
import {
  acceptRichQuest,
  addRichQuestNote,
