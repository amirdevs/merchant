...
import type { Character, InventoryEntry, Item, Kingdom, Marketplace, ObtainableItem, Profession } from "@/shared/types/game-data";
import { appraiseOffer, valueOffer, visibleOfferableInventory, type TradePerspective } from "@/game/trade/barter";
import type { AuctionSession } from "@/game/trade/auction";
import type { RaceResult } from "@/game/market/racing";
import { createMythProgression, type MythProgression, type MythSession } from "@/game/market/myth";
import { advanceMarketSimulation, recordMarketTrade, seasonalMarketBiases, simulatedMarketBiases, type MarketSimulation } from "@/game/market/market-simulation";
import { createCompanyState, settleShipments, type CompanyState } from "@/game/company/company";
import type { DraftSession } from "@/game/trade/draft";
import { applyPackhorseTravelWear, applyTravelConditions, createCaravanState, masteryRiskReduction, recordRoute, routeKey, routeTravelConditions, type CaravanState } from "@/game/company/caravan";
import { activePermit, adjustKingdomHeat, canUseBlackMarket, coolLawHeat, createLawState, kingdomHeat, permitInspectionMultiplier, type LawState } from "@/game/company/law";
import { npcRoles } from "@/game/characters/npc-behavior";
import { advanceRivals, createRivalState, type RivalState } from "@/game/company/rivals";
import { expireContracts, type ContractAcceptedDays, type ContractStates } from "@/game/quests/contracts";
import { canPayCopperToll, inventoryTotals, spendCopperToll } from "@/game/economy/economy";
import { eventBiases } from "@/game/market/events";
import type { DialogueNodeId } from "@/game/characters/dialogue";
import { addInventory, clearOffers, moveOffer, transferOffers, visibleQuantity } from "@/game/trade/inventory";
...
} from "@/game/characters/npc-behavior";
import { charactersAtMarket, nextCustomerIndex, selectedCharacter } from "@/game/characters/npc-flow";
import { ensureRelation, type NpcRelations, reactionText, startingPatience, ultimatumActive } from "@/game/characters/reputation";
import { deleteGameSave, importGame, loadGame, saveGame, serializeGame } from "./save";
import { applyTravelRisks, routeRiskPreview, type TravelStrategy } from "@/game/travel/travel-risk";
import { expireQuests, questOfferCanComplete, questReward } from "@/game/quests/quests";
import { stockArchetypes } from "@/content/market/stock/archetypes";
