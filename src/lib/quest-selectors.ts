import { authoredQuests, questCatalog } from "../data/quests/questCatalog";
import type { QuestCatalog, RichQuest } from "../data/quests/questTypes";
import { richQuestIsActive, richQuestStatus, type RichQuestRuntimeState } from "./quest-state";
