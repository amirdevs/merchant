...
import { currentKingdom, currentMarket, items, kingdoms, marketplaces, type GameState } from "@/game/runtime/game";
import { marketEventPreviews } from "@/game/market/events";
import { contractDeadline, contractItemProgress, generatedContracts, resolveContract } from "@/game/quests/contracts";
import { marketRumorLedger, seasonalMarketReport } from "@/game/market/market-simulation";
